    ...
    for (let i = 0; i < pbaasConfig.length; i++) {
        ...
        if (currencyInfo) {
            ...
            pbaasArray.push({
                ...
                stakingRewardsDaily: stakingRewards.stakingRewardsDaily,
                stakingRewardsDailyUSD: stakingRewards.stakingRewardsDailyUSD,
                stakingRewardsMonthly: stakingRewards.stakingRewardsMonthly,
                stakingRewardsMonthlyUSD: stakingRewards.stakingRewardsMonthlyUSD,
                stakingRewardsYearly: stakingRewards.stakingRewardsYearly,
                stakingRewardsYearlyUSD: stakingRewards.stakingRewardsYearlyUSD,
                ...
                miningHash: miningRewards.miningHash,
                miningRewardsDaily: miningRewards.miningRewardsDaily,
                miningRewardsDailyUSD: miningRewards.miningRewardsDailyUSD,
                miningRewardsMonthly: miningRewards.miningRewardsMonthly,
                miningRewardsMonthlyUSD: miningRewards.miningRewardsMonthlyUSD,
                miningRewardsYearly: miningRewards.miningRewardsYearly,
                miningRewardsYearlyUSD: miningRewards.miningRewardsYearlyUSD,
