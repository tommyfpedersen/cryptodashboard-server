...
export async function currencyReserveChipsBridge(priceArray, vrscBridgePrice) {
    let result = {};

    /* VRSC-ETH Bridge reserves */
    const getcurrencyResponse = await fetch(process.env.VERUS_REST_API_CHIPS + "multichain/getcurrency/bridge.chips");
